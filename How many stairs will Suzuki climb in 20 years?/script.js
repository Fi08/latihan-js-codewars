// ---------------- CARA SEDIKIT BARBAR -------------------------
function stairsIn20(data) {
   return data.map(x => x.reduce((a, b) => a + b, 0)).reduce((a, b) => a + b) * 20;
}
// --------------------------------------------------------
...
//       let w = data[i].reduce((a, b) => a + b, 0);
//       everyWeek.push(w);
//    }

//    for (let i = 0; i < everyWeek.length; i++) {
//       let y = everyWeek.reduce((a, b) => a + b, 0);
//       everyYear = y;
//    }
//    return everyYear * 20;
// }
